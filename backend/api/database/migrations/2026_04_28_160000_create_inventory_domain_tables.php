...
return new class extends Migration
{
    ...
    {
        // Esta migración es idempotente: las tablas pueden haber sido creadas
        // por la migración 140000 en instalaciones anteriores. Solo creamos
        // las que no existen todavía (instalaciones limpias).
        ...
        if (! Schema::hasTable('app_user_roles')) {
        ...
        if (! Schema::hasTable('movement_lines')) {
        ...
        if (! Schema::hasTable('alert_events')) {
